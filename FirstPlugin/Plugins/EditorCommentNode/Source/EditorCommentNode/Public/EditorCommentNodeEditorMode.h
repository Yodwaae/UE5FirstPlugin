...
#include "EditorCommentNodeEditorMode.generated.h"
 ...
 */
UCLASS()
class UEditorCommentNodeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_EditorCommentNodeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UEditorCommentNodeEditorMode();
	virtual ~UEditorCommentNodeEditorMode();
