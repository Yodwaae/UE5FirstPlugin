...
#include "EditorCommentNodeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UEditorCommentNodeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UEditorCommentNodeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UEditorCommentNodeInteractiveTool* NewTool = NewObject<UEditorCommentNodeInteractiveTool>(SceneState.ToolManager);
...
void UEditorCommentNodeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UEditorCommentNodeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UEditorCommentNodeInteractiveToolProperties>(this, "Measurement");
...
void UEditorCommentNodeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UEditorCommentNodeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UEditorCommentNodeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UEditorCommentNodeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UEditorCommentNodeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UEditorCommentNodeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UEditorCommentNodeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UEditorCommentNodeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UEditorCommentNodeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
