...
#include "EditorCommentNodeSimpleTool.h"
...
#define LOCTEXT_NAMESPACE "EditorCommentNodeSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UEditorCommentNodeSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UEditorCommentNodeSimpleTool* NewTool = NewObject<UEditorCommentNodeSimpleTool>(SceneState.ToolManager);
...
void UEditorCommentNodeSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void UEditorCommentNodeSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UEditorCommentNodeSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void UEditorCommentNodeSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
